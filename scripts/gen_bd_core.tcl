...
proc create_hier_cell_MemoryBuffer { parentCell nameHier } {
  ...
  set_property -dict [ list CONFIG.c_m_axi_mm2s_addr_width {64} CONFIG.c_m_axi_mm2s_data_width {256} CONFIG.c_m_axi_s2mm_addr_width {64} CONFIG.c_m_axi_s2mm_data_width {256} CONFIG.c_m_axis_mm2s_tdata_width {32} CONFIG.c_mm2s_btt_used {23} CONFIG.c_mm2s_burst_size {64} CONFIG.c_s2mm_btt_used {23} CONFIG.c_s2mm_burst_size {64}  ] $axi_dm_buffer
  ...
  connect_bd_intf_net -intf_net axi_dm_buffer_M_AXI_MM2S [get_bd_intf_pins axi_dm_buffer/M_AXI_MM2S] [get_bd_intf_pins buffer_interconnect_0/S00_AXI]
  connect_bd_intf_net -intf_net axi_dm_buffer_M_AXI_S2MM [get_bd_intf_pins axi_dm_buffer/M_AXI_S2MM] [get_bd_intf_pins buffer_interconnect_0/S01_AXI]
...
proc create_root_design { parentCell } {
  ...
  set_property -dict [ list CONFIG.ENABLE_ADVANCED_OPTIONS {1} CONFIG.NUM_MI {5} CONFIG.S00_HAS_DATA_FIFO {0} CONFIG.S00_HAS_REGSLICE {4}  ] $axi_interconnect_0
  ...
  connect_bd_intf_net -intf_net axi_interconnect_0_M04_AXI [get_bd_intf_pins MemoryBuffer/S02_AXI] [get_bd_intf_pins axi_interconnect_0/M04_AXI]
  ...
  connect_bd_net -net microblaze_0_Clk [get_bd_ports clk100] [get_bd_pins INTC/processor_clk] [get_bd_pins MCU/Clk] [get_bd_pins MemoryBuffer/clk100] [get_bd_pins axi_gpio_0/s_axi_aclk] [get_bd_pins axi_interconnect_0/ACLK] [get_bd_pins axi_interconnect_0/M00_ACLK] [get_bd_pins axi_interconnect_0/M01_ACLK] [get_bd_pins axi_interconnect_0/M02_ACLK] [get_bd_pins axi_interconnect_0/M03_ACLK] [get_bd_pins axi_interconnect_0/M04_ACLK] [get_bd_pins axi_interconnect_0/S00_ACLK] [get_bd_pins axi_uart_fpga_output/s_axi_aclk] [get_bd_pins clk_wiz_1/clk_out1] [get_bd_pins rst_clk_wiz_1_100M/slowest_sync_clk] [get_bd_pins xadc_wiz_0/s_axi_aclk]
  ...
  connect_bd_net -net rst_clk_wiz_1_100M_peripheral_aresetn [get_bd_pins INTC/s_axi_aresetn] [get_bd_pins MCU/s_axi_aresetn] [get_bd_pins MemoryBuffer/m_axis_s2mm_cmdsts_aresetn] [get_bd_pins axi_gpio_0/s_axi_aresetn] [get_bd_pins axi_interconnect_0/M00_ARESETN] [get_bd_pins axi_interconnect_0/M01_ARESETN] [get_bd_pins axi_interconnect_0/M02_ARESETN] [get_bd_pins axi_interconnect_0/M03_ARESETN] [get_bd_pins axi_interconnect_0/M04_ARESETN] [get_bd_pins axi_interconnect_0/S00_ARESETN] [get_bd_pins axi_uart_fpga_output/s_axi_aresetn] [get_bd_pins rst_clk_wiz_1_100M/peripheral_aresetn] [get_bd_pins xadc_wiz_0/s_axi_aresetn]
